...
function createCard(cityData) {
    ...
    if (cityData.weather[0].main == "Clouds" || cityData.weather[0].main == "Clear" || cityData.weather[0].main == "Haze" || cityData.weather[0].main == "Mist" ) 
    {
    ...
    else if(cityData.weather[0].main == "Drizzle") 
    {
     ...
     else if(cityData.weather[0].main == "Sunny"){
      weatherImgString = "./Images/sunny.png";
     }
